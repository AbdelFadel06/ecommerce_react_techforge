...
const ProductCard = ({ product }) => {
    ...
    return (
        <>
            <div className="w-full sm:w-[90%] md:w-full mx-auto p-3 sm:p-4 rounded-2xl bg-white shadow-md" onClick={handleClick}>
                <div>
                    <img
                ...
                <div className="p-3 space-y-2 text-gray-700">
                    ...
                    <div className="flex justify-between">
                        <h1 className="font-medium">{product.category}</h1>
                    ...
                    <h1 className={`flex justify-end ${Availability[product.availability].color} `}>
